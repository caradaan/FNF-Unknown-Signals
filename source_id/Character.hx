...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'id':
				frames = Paths.getSparrowAtlas('id/id');
				animation.addByPrefix('idle', 'id idle', 24, false);
				animation.addByPrefix('singUP', 'id up', 24, false);
				animation.addByPrefix('singDOWN', 'id down', 24, false);
				animation.addByPrefix('singLEFT', 'id left', 24, false);
				animation.addByPrefix('singRIGHT', 'id right', 24, false);
			...
			case 'otto':
				frames = Paths.getSparrowAtlas('otto/otto');
				animation.addByPrefix('idle', 'otto idle', 24, false);
				animation.addByPrefix('singUP', 'otto up', 24, false);
				animation.addByPrefix('singDOWN', 'otto down', 24, false);
				animation.addByPrefix('singLEFT', 'otto left', 24, false);
				animation.addByPrefix('singRIGHT', 'otto right', 24, false);
