...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		...
		'id' => new CharacterSetting(70, 110, 2.3),
		'otto' => new CharacterSetting(-15, 110, 1.3),//130hight
	];
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool)
	{
		...
		animation.addByPrefix('id', "idLine", 24, false);
		animation.addByPrefix('otto', "ottoLine", 24, false);
